...
<span {{ $attributes->merge(['class' => 'inline-flex flex-col items-center text-center leading-none']) }} role="img" aria-label="{{ __('ui.property.energy_class', ['class' => $letra]) }}">
    <svg viewBox="0 0 64 60" class="h-14 w-14" aria-hidden="true">
    ...
    <span class="mt-1 text-[0.58rem] font-bold uppercase tracking-wide text-ink">{{ __('ui.property.energy_class_label') }}</span>
</span>
