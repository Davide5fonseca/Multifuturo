        ...
        <fieldset x-show="$store.consent.customizing" x-cloak class="mt-6 grid gap-4 border-t border-sand-200 pt-6 sm:grid-cols-3">
            ...
            <label class="text-sm">
                <span class="flex items-center justify-between font-medium">
                    ...
                    <input type="checkbox" x-model="$store.consent.choices.analytics" class="h-4 w-4 accent-olive-600">
                </span>
            ...
            <label class="text-sm">
                <span class="flex items-center justify-between font-medium">
                    ...
                    <input type="checkbox" x-model="$store.consent.choices.marketing" class="h-4 w-4 accent-olive-600">
                </span>
